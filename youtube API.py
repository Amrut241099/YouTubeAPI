...
icon = Image.open(r"C:\Users\thaku\OneDrive\Desktop\YouTube API\youtube.png")
st.set_page_config(page_title= "Youtube Data Harvesting and Warehousing | By AMRUT THAKUR",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This app is created by *AMRUT THAKUR*"""})
...
mydb = sql.connect(host="localhost",
                   user="root",
                  password="Sharad@2410",
                   database= "youtube_db"
                 )
mycursor = mydb.cursor(buffered=True)

# BUILDING CONNECTION WITH YOUTUBE API
api_key = "AIzaSyAdSvQ7mzYmmZBwff2FtMswSq1acobS8rc"
...
if selected == "Home":
    ...
    col2.markdown("#   ")
    col2.markdown("#   ")
    col2.image(r"C:\Users\thaku\OneDrive\Desktop\YouTube API\youtubeMain.jpeg")
